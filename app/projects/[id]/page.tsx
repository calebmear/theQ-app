      ...
      <div className="rounded-2xl bg-white p-6 shadow">
        ...
        <div className="mt-4 grid gap-4 md:grid-cols-4">
          ...
          <div>
            ...
            <p className="font-semibold">{project.assignedTo}</p>
          </div>
          <div>
          ...
          <div>
            ...
            <p className="font-semibold">{project.targetCompletion}</p>
          </div>
        </div>
      </div>
        ...
        <div className="mt-4 grid gap-4 md:grid-cols-2">
          ...
          <div>
            ...
            >
              ...
              <option className="text-black">2016 Ford Van</option>
              <option className="text-black">2007 Ford F-150</option>
            </select>
          </div>
            ...
            <div key={entry.id} className="rounded-xl border p-4">
              <div className="flex items-start justify-between">
                <div>
                  ...
                  <p className="font-semibold">{entry.submittedAt}</p>
                </div>
              ...
              <div className="mt-4 space-y-3 text-sm">
                ...
                <div>
                  ...
                  <p className="font-medium">{entry.workCompleted}</p>
                </div>
              ...
              <div className="mt-4 flex gap-2">
                <button className="flex-1 rounded-lg border px-3 py-2 text-sm hover:bg-gray-100">
                  Edit
                </button>
                <button className="flex-1 rounded-lg border px-3 py-2 text-sm text-red-600 hover:bg-red-50">
                  Delete
                </button>
              </div>
            </div>
            ...
            <tbody>
              {projectTimeEntries.map((entry) => (
                <tr key={entry.id} className="border-t align-top">
                  ...
                  <td className="max-w-xs p-4 text-gray-600">{entry.notes}</td>
                  <td className="p-4">
